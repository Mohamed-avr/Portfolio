...
const Card = (props) => {
    return (
             ...
             <article key={props.sendkey} className=" sm:w-[24.7rem] w-[95%] h-[23rem] p-4 relative  text-center flex-col items-center justify-start flex text-3xl  text-white m-2 bg-nav  border-nav/50 border-2  ">
